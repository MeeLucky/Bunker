...
public class Data {
    ...
    public static String getDisaster() {
        String[] disasters = new String[] {
                ...
                "Из-за ядерной войны, 90% человечества погибло, остальные укрылись в бункерах, из-за радиации сильно изменилась почва и загрязнились водоёмы, а большенство живых организмов вымерло из-за кислотных дождей или адпатировалось и мутировало в опасных тварей, в бункере придётся жить 10 лет",

                "Из-за землетрясения рекордной силы, в следствии чего северная америка отодвинулась от европы и всё населения этих континентов погибло, а на остальных континентах города превратились в руины. Вызваные землетрясением цунами затопили приморские страны, а вулканы разогрели мировой океан из-за чего все рыбные виды погибли. Население земли - это единицы счастливчиков выживших на поверхности и люди в бункерах. В бункере придётся жить 1 месяц",

                "Из-за извержения супер вулкана в атмосферу були выброшены сотни тысячи кубических километров пепла, что привело к её загрязнению, «вулканической зиме» и всемирному похолоданию на 10-20 °С. Часть населения земли погило сразу от взрыва и удушья. В северных странах инфраструктура не в состоянии справляться с экстремальными морозами, и часть население погибло от холода. Из-за неурожаев начался мировой голод и войны под покровм пелены раскалённого пепла и кислотными дождями. В бункере придётся жить 4 года.",

                "Смертельный вирус вышел из под контроля и спровацировал глобальную эпидемию. Но после выхода из бункера выявлена мутация практически всех растений и животных. Остаток здорового населения 8%. В бункере придётся жить 4 месяца."
...
//Todo: ispravit
    ...
    private String[] skills = new String[] {
            "обменять богаж с любым игроком",
